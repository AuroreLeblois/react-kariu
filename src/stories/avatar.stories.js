...
export default {
  ...
  argTypes: {
    name: {
      ...
      description:
        "Take string and convert it into an array: this only works with 1 space or 0 space into the string",
      control: { type: "text" },
    },
    url: {
    ...
    backgroundColor: {
      description:
        "Only required if you don't provide an url or an icon to the component",
      control: "color",
    },
    textColor: {
      description:
