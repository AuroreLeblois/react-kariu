...
export default {
  ...
  argTypes: {
    ...
    vhead: {
      description:
        "data to display in the vertical header, aka cells of the first column",
      defaultValue: null,
      control: { type: "text" },
    },
    fontFamily: {
...
Default.args = {
  ...
  infos: [
    ...
    {
      unavailability_code: "RDV",
      name: "Doctor",
      unavailability_date_start: "2021-10-03",
      unavailability_time_start: "09:00",
      unavailability_time_end: "10:00",
      marked: true,
    },
  ],
  vhead: [
...
export const Empty = (args, { parameters }) => (
  <div className={css(styleTable)}>
    <Calendar {...args} monthSelected={9} yearSelected={2021} />
  </div>
);
