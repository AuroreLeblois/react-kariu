...
function SvgSvgSoundOff(props) {
  return (
    <svg
      className="SvgSoundOff_svg__svg-icon"
      viewBox="0 0 20 20"
      width="1em"
      height="1em"
