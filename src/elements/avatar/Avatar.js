...
const Avatar = (props) => {
  ...
  if (props.customWidthAndHeight) {
    (avatar.width = props.customWidthAndHeight),
      (avatar.height = props.customWidthAndHeight);
  }
...
Avatar.propTypes = {
  ...
  size: PropTypes.oneOf(["big", "medium", "giant", "small"]),
  shape: PropTypes.oneOf(["square", "round"]),
  customWidthAndHeight: PropTypes.string,
};
