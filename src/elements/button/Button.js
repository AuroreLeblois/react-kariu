...
const Button = (props) => {
  ...
  switch (props.size) {
    case "xSmall":
      (styleBtn.fontSize = "0.45rem"), (styleBtn.padding = "0.45rem");
      break;
    case "small":
      (styleBtn.fontSize = "0.55rem"), (styleBtn.padding = "0.55rem");
      break;
    case "large":
      (styleBtn.fontSize = "1.25rem"), (styleBtn.padding = "1rem");
      break;
    default:
      styleBtn;
      break;
  ...
  const renderIcon = () => {
    ...
    if (props.icon) {
      return (
        <Icon
          className={"kariu-button--icon " + css(styleIcon)}
          width={iconSize}
          height={iconSize}
          icon={props.icon}
          color={color}
